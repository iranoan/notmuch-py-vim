...
syntax cluster	mailHeaderField2	contains=mailHeaderKey,mailHeaderShow,@mailHeaderComp,@mailHeaderField
...
syntax region	mailHeader2	contains=mailHideHeader,@mailHeaderField2,@NoSpell start='\%^' skip='^\s' end='^$'me=s-1 fold

...
上の ***F\_WIN***, ***T\_WIN***, ***S\_WIN*** の意味と操作法ははそれぞれ次のとおり

***F\_WIN***

* 擬似的なメール・フォルダのフォルダー・ツリー
* **o** で ***T\_WIN*** にメール一覧を表示
* ``:bwipeout`` すると他の ***T\_WIN***/***S\_WIN*** や未編集の送信バッファも閉じられる

***T\_WIN***

* スレッド・ツリー
* デフォルトでは全体の 1/4 程度の高さ
* ***S\_WIN*** のウィンドウが有れば、カーソル位置のメールを ***S\_WIN*** に表示する
* **o** でスレッド開閉
* ステータス・バーにタグなどの情報を表示
* zn を無効にしている
...
この時 ***F\_WIN*** ならカーソル位置、他なら開いているメールと設定の組み合わせで、To ヘッダが入力済みになる場合が有る
